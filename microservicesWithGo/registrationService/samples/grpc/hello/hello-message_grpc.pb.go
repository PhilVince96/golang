...
type HelloWorldServiceClient interface {
	SayHello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HelloMessage, error)
}
...
func (c *helloWorldServiceClient) SayHello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HelloMessage, error) {
...
type HelloWorldServiceServer interface {
	SayHello(context.Context, *emptypb.Empty) (*HelloMessage, error)
...
func (UnimplementedHelloWorldServiceServer) SayHello(context.Context, *emptypb.Empty) (*HelloMessage, error) {
...
func _HelloWorldService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).SayHello(ctx, req.(*emptypb.Empty))
	}
